...
Real pdf_sample_bsdf_op::operator()(const DisneyBSDF &bsdf) const {
    ...
    Real weight_clearcaot = 0;
    if (reflect) {
        weight_diffuse = (1 - metallic) * (1 - specular_transmission);
        weight_metal = (1 - specular_transmission * (1 - metallic));
        weight_clearcaot = .25 * clearcoat;
    }
    Real weight_total = weight_diffuse + weight_metal + weight_glass + weight_clearcaot;
